...
func (t *Trader) Buy(price, quantity int) error {
  ...
  t.createContract(ourFunding,theirFunding,valueFullyOurs,valueFullyTheirs)
  return nil
}
...
//
func (t *Trader) createContract(ourFunding, theirFunding, valueFullyOurs, valueFullyTheirs int64) (error) {
